...
public class BookmarkApiAccessor {
    ...
    public static Observable<JSONObject> requestAddBookmark(final String url, final Account account) {
    ...
    public static Observable<JSONObject> requestIsAlreadyBookmark(final String url, final Account account) {
        return Observable.create(new Observable.OnSubscribe<JSONObject>() {
            @Override
            public void call(Subscriber<? super JSONObject> subscriber) {
                OAuthService oAuthService = new ServiceBuilder()
